...
public class __db_set_flags_msg implements XdrAble {
    public int dbpcl_id;
    public int flags;

    public __db_set_flags_msg() {
    }

    public __db_set_flags_msg(XdrDecodingStream xdr)
...
// End of __db_set_flags_msg.java
