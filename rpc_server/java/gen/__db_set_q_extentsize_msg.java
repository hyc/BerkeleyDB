...
public class __db_set_q_extentsize_msg implements XdrAble {
    public int dbpcl_id;
    public int extentsize;

    public __db_set_q_extentsize_msg() {
    }

    public __db_set_q_extentsize_msg(XdrDecodingStream xdr)
...
// End of __db_set_q_extentsize_msg.java
