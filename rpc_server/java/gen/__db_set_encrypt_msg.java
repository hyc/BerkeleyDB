...
public class __db_set_encrypt_msg implements XdrAble {
    public int dbpcl_id;
    public String passwd;
    public int flags;

    public __db_set_encrypt_msg() {
    }

    public __db_set_encrypt_msg(XdrDecodingStream xdr)
...
// End of __db_set_encrypt_msg.java
