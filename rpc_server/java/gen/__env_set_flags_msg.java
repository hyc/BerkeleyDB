...
public class __env_set_flags_msg implements XdrAble {
    public int dbenvcl_id;
    public int flags;
    public int onoff;

    public __env_set_flags_msg() {
    }

    public __env_set_flags_msg(XdrDecodingStream xdr)
...
// End of __env_set_flags_msg.java
