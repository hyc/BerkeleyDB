...
int __memp_get_refcnt __P((DB_ENV *, DB *, u_int32_t *));
...
void __memp_bucket_reorder __P((DB_MPOOL_HASH *, BH *));
...
int __memp_bh_freezefree __P((DB_MPOOL *, REGINFO *, DB_MPOOL_HASH *, BH *, BH *));
int __memp_bh_unfreeze __P((DB_MPOOL *, REGINFO *, DB_MPOOL_HASH *, BH *, BH *));
