...
public interface DbConstants
{
    ...
    int DB_EVENT_REP_PERM_FAILED = 5;
    int DB_EVENT_REP_STARTUPDONE = 6;
    int DB_EVENT_WRITE_FAILED = 7;
    ...
    int DB_REP_CONNECTION_RETRY = 2;
    int DB_REP_ELECTION = 2;
    int DB_REP_ELECTION_RETRY = 4;
    int DB_REP_ELECTION_TIMEOUT = 3;
    int DB_REP_FULL_ELECTION_TIMEOUT = 5;
