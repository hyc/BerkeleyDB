...
proc repmgr015 { method { niter 100 } { tnum "015" } args } {
	...
	puts "Repmgr$tnum ($method): Basic repmgr in-memory election test."
	repmgr015_sub $method $niter $tnum $args
}

proc repmgr015_sub { method niter tnum largs } {
	global testdir 
	global rep_verbose 
	global verbose_type
	set nsites 3
	...
	# Open third client
	set cl3_envcmd "berkdb_env_noerr -create $verbargs -errpfx CLIENT3 \
	    -home $clientdir3 -txn -rep -thread -rep_inmem_files"
